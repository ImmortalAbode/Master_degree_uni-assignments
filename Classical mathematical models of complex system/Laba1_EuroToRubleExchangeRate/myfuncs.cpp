                               ...
                               RegressionValues &values)
{
    ...
    values.regCoefStr = QString("<b>Вспомогательные величины:</b><br>"
                            ...
                            .arg(QString::number(values.coeffs["A"], 'f', 6))
                            .arg(QString::number(values.coeffs["A0"], 'f', 6))
                            .arg(QString::number(values.coeffs["A1"], 'f', 6))
                            .arg(QString::number(values.coeffs["B"], 'f', 6))
                            .arg(QString::number(values.coeffs["B0"], 'f', 6))
                            .arg(QString::number(values.coeffs["B1"], 'f', 6))
                            .arg(QString::number(values.coeffs["a0"], 'f', 6))
                            .arg(QString::number(values.coeffs["a1"], 'f', 6))
                            .arg(QString::number(values.coeffs["b0"], 'f', 6))
                            .arg(QString::number(values.coeffs["b1"], 'f', 6));
    ...
    for (int i = 0; i < values.n; ++i)
    {
        ...
        double y{ cursValues[i] };
        double y_pred{};
        (inverse == false) ? y_pred = values.coeffs["a0"] + values.coeffs["a1"] * x
